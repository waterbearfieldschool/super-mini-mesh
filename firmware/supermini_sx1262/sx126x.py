...
class SX126X:
    ...
    def __init__(self, spi_bus, clk, mosi, miso, cs, irq, rst, gpio):
        ...
        if implementation.name == 'circuitpython':
          ...
          self.spi.unlock()
          self.cs = digitalio.DigitalInOut(board.P1_13)
          self.cs.switch_to_output(value=True)
          self.irq = digitalio.DigitalInOut(board.P0_10)
          self.irq.switch_to_input()
          self.rst = digitalio.DigitalInOut(board.P0_09)
          self.rst.switch_to_output(value=True)
          self.gpio = digitalio.DigitalInOut(board.P0_29)
